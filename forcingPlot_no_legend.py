...
fig, (ax11, ax22, ax3) = plt.subplots(3, sharex=True, figsize=(6,7))
# fig, (ax1, ax2) = plt.subplots(2, sharex=True, figsize=(6,7))

ax11.set_title("Input").set_fontsize(15)
...
ax22.set_title("Output").set_fontsize(15)
...
ax3.set_ylim(ymin=0)
ax3.get_yaxis().set_label_coords(1.15,0.5)
...
ax22.tick_params(labelrotation=20)
